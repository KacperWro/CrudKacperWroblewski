...
<form action="add_user.php" method="post" id="add_user_form" enctype="multipart/form-data" name="userForm" onSubmit="return validateUserForm()">
    <div class="form-group row">
        <label for="inputEmail3" class="col-sm-2 col-form-label">Username</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" name="name" placeholder="Username must be alphanumeric and 3-20 characters in length. It must not contain spaces" onChange="return validateUserForm()">
